...
import com.tabs.activity.FollowersListActivity;
import com.tabs.activity.FollowingListActivity;
...
public class TabsUtil {
    ...
    public static void setupProfileView(final View view, final String callingActivityName, FireBaseApplication fireBaseApplication, DatabaseQuery databaseQuery, String ... intentVariables) {
        ...
        followersButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(view.getContext(), FollowersListActivity.class);
        ...
        followingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(view.getContext(), FollowingListActivity.class);
                intent.putExtras(bundle);
                view.getContext().startActivity(intent);
            }
        });
    ...
    private static boolean checkPostsLength(RecyclerView view) {
    ...
    private static boolean checkCommentsLength(ListView view) {
