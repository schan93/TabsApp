...
public class FireBaseApplication extends Application {
    ...
    public void initializeAdapters() {
        ...
        setPublicAdapter(new PostRecyclerViewAdapter(publicPosts, AdapterEnum.Public));
        setMyTabsAdapter(new PostRecyclerViewAdapter(myTabsPosts, AdapterEnum.ProfilePosts));
        setFollowingPostAdapter(new PostRecyclerViewAdapter(followingPosts, AdapterEnum.Following));
        ...
        setUserAdapter(new PostRecyclerViewAdapter(userPosts, AdapterEnum.UserPosts));
        setPostsThatCurrentUserHasCommentedOnAdapter(new PostRecyclerViewAdapter(commentPosts, AdapterEnum.ProfileComments));
        setPostsUserHasCommentedOnAdapter(new PostRecyclerViewAdapter(userCommentPosts, AdapterEnum.UserComments));
        setCommentsCount(0);
        setPostCount(0);
        setName("");
        setUserId("");
